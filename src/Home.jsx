...
const Home = () => {
  ...
  return (
    <div className="flex items-center justify-center w-screen min-h-screen pt-16 pb-12 font-medium">
      <div className="flex flex-grow items-center justify-center bg-gray-900 h-full">
        <div className="max-w-full p-8 bg-gray-800 rounded-lg shadow-lg w-xs sm:w-3/4 md:w-1/2 text-gray-200">
